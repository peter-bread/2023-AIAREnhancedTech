...
- Within the Galasa application, select the Instructions button to see further deatils about how to interact with the appliaction
- Select the link in our 'about' to be taken to our Github pages. This page displays all the diagrams you can interact it in the application.
- Choose a diagram you would like to learn more about and then click it's corresponding button to make its unique QR code visible.
